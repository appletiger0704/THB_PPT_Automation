...
update_date(first_slide, first_page_pattern, f"{convert_to_minguo(now.year)}年{now_month}月{now_day}日 0900時", RGBColor(00,00,00), 24)
...
update_date(forth_slide, yday_accumulate_pattern, f"昨({yesterday_day})日 累積雨量", RGBColor(12,51,115), 18)
update_date(forth_slide, tday_accumulate_pattern, f"今({now_day})日 00-06時 累積雨量", RGBColor(12,51,115), 18)
